...
<div class="cart-item-quantity">
  <button @click="decrementBook(book)" class="plain">
    <span class="mdi mdi-minus" />
  </button>
  {{ book.quantity }}
  <button @click="incrementBook(book)" class="plain">
    <span class="mdi mdi-plus" />
  </button>
</div>
          </td>
          <td class="cart-item-subtotal">
            R$ {{ (book.price * book.quantity).toFixed(2) }}
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <div class="cart-summary">
      ...
      <div class="summary">
        ...
        <button @click="zerarCarrinho()">Esvaziar carrinho</button>
      </div>
      </div>
    </div>
  </section>
