...
<template>
<header class="flex justify-between px-[2vw] border-b-[2px] border-[#dedede] border-solid h-[5vw] items-end">
    <!--3E1E04-->
  ...
  <div v-if="tasks" class="flex flex-col gap-[0.5vw] items-baseline z-1 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-[2px] border-[#dedede] border-solid bg-white p-[1vw] text-[2vw] rounded-[15px]">
