...
const rotas = router.getRoutes().slice(1, 4)
</script>

<template>
<header class="flex justify-between px-[2vw] border-b-[1.5px] border-[#dedede] border-solid h-[5vw] items-end">
    <!--3E1E04-->
  ...
  <div class="bg-gray-200 p-[0.8vw] rounded-full mb-[1vw]">
    <button @click="aviso"><img class="w-[3vw] h-[3vw]" src="../../public/icons/perfil.png" alt="perfil"></button>
  </div>
</header>
</template>
